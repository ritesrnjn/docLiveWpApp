...
namespace DoctorLive
{
    public partial class App : Application
    {
        ...
        //    var hub = new NotificationHub("doctorlive>",
        //                    "Endpoint=sb://doctorlive-ns.servicebus.windows.net/;SharedAccessKeyName=DefaultFullSharedAccessSignature;SharedAccessKey=6H2WmJ8PgjhgRJksBO1Pui+6U3Sa+l6UyEjByozyb5k=");
        ...
        //private const string HUB_NAME = "doctorlive";
        ...
        //private const string CONNECTION_STRING = "Endpoint=sb://doctorlive-ns.servicebus.windows.net/;SharedAccessKeyName=DefaultListenSharedAccessSignature;SharedAccessKey=YmYaa28T+xOjrNH2sZR+93a+j7dMKenWTI2ofAE6tDA=";
        ...
        //        var result = await hub.RegisterNativeAsync(channel.Uri, new string[] { "userId", "SUPPORT" });
        //    }
        //    catch (Exception ex)
        //    {
        ...
        public static MobileServiceClient MobileService = new MobileServiceClient(
            "https://doctorlive.azure-mobile.net/",
            "ynxXHlBeHMqkWoAhkwgxGqwZUovghV96"
            );
        ...
        public App()
        {
            ...
            {
                var hub = new NotificationHub("doctorlive", "Endpoint=sb://doctorlive-ns.servicebus.windows.net/;SharedAccessKeyName=DefaultListenSharedAccessSignature;SharedAccessKey=YmYaa28T+xOjrNH2sZR+93a+j7dMKenWTI2ofAE6tDA=");

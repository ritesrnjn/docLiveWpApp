...
{
    public partial class FeedPage1 : PhoneApplicationPage
     
    {
        ...
        async void MainPage_loaded(object sender, RoutedEventArgs e)
        {
            ...
            webClient.DownloadStringAsync(new System.Uri("http://www.medicinenet.com/rss/general/exercise_and_fitness.xml"));
        }

        // Click handler that runs when the 'Load Feed' or 'Refresh Feed' button is clicked. 
        public void loadFeedButton_Click(object sender, System.Windows.RoutedEventArgs e)
        {
